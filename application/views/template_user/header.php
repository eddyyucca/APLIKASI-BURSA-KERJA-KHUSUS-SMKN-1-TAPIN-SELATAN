				...
				<li class="nav-item">
					...
					<div id="Password" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="<?= base_url('user/edit_profil') ?>">Edit Profil</a>
						</div>
					</div>
				</li>
				<li class="nav-item">
					...
					<div id="loker" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="<?= base_url('user/data_lowongan') ?>">Semua Loker</a>
							<a class="collapse-item" href="<?= base_url('user/data_lowongan_gd') ?>">Loker Gender</a>
