		...
		<div class="card-body">
			<div class="row">
				<div class="container-fluid">
					<?= validation_errors() ?>
					<form action="<?= base_url('mitra/proses_update_lowongan/' . $data->id_lowongan)  ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama_perusahaan" name="mitra" value="<?= $data->nama_mitra ?>" placeholder="Nama Perusahaan/isntansi">
						</div>
						<div class="form-group">
