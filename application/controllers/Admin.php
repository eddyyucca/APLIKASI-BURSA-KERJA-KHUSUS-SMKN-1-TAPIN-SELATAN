...
class Admin extends CI_Controller
{
	...
	{
		$data['judul'] = 'Data Permintaan alumni';
		$data['nama'] = $this->session->userdata('nama_alumni');
		$data['data'] = $this->alumni_m->get_all_permintaan();
		$data['lapor'] = false;

		$this->load->view('template/header', $data);
		$this->load->view('admin/alumni/permintaan', $data);
		$this->load->view('template/footer');
	}
	...
	public function terima_permintaan($telpon_alumni)
	{
		$userkey = 'f70595dcb94f';
		$passkey = 'da5d1066b8f2e8343646fb16';
		$telepon = $telpon_alumni;
		$message = 'Akun anda sudah diterima admin BKK SMKN 1 Tapin Selatan,Silahkan Login';
		...
		$this->db->where('telpon', $telpon_alumni);
		$this->db->update('akun', $data);
